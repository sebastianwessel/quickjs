...
onMounted(async () => {
	...
	// Load QuickJS
	const { loadQuickJs } = await import('https://esm.sh/@sebastianwessel/quickjs@3.0.1')
	const variant = await import('https://esm.sh/@jitl/quickjs-ng-wasmfile-release-sync@0.31.0')
